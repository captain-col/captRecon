#ifndef TCaptainMinerva_hxx_seen
#define TCaptainMinerva_hxx_seen
...
class CP::TCaptainMinerva: public CP::TAlgorithm {
public:
    TCaptainMinerva();
    virtual ~TCaptainMinerva();
